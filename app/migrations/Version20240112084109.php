 ...
 */
final class Version20240112084109 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE exemplaire (id INT AUTO_INCREMENT NOT NULL, type_id INT NOT NULL, panier_id INT DEFAULT NULL, taille INT NOT NULL, couleur VARCHAR(255) NOT NULL, INDEX IDX_5EF83C92C54C8C93 (type_id), INDEX IDX_5EF83C92F77D927C (panier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
